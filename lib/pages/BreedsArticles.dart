...
class BreedsArticles extends StatefulWidget {
  const BreedsArticles({Key? key}) : super(key: key);

  @override
  State<BreedsArticles> createState() => _BreedsArticlesState();
}

class _BreedsArticlesState extends State<BreedsArticles> {
  @override
  void initState(){
    super.initState();
    getWebsiteData();
  ...
  Future getWebsiteData() async {
    final url = Uri.parse('https://www.thesprucepets.com/dog-breeds-4162141');
        ...
        body: SingleChildScrollView(
          child: Column(children: <Widget>[
            ...
            ListView.builder(
              ...
              itemCount: breeds_articles.length,
              scrollDirection: Axis.vertical,
              shrinkWrap: true,
              itemBuilder: (context, index) {
                final article = breeds_articles[index];
