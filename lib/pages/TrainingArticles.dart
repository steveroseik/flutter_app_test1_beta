...
class TrainingArticles extends StatefulWidget {
  const TrainingArticles({Key? key}) : super(key: key);

  @override
  State<TrainingArticles> createState() => _TrainingArticlesState();
}

class _TrainingArticlesState extends State<TrainingArticles> {
  @override
  void initState(){
    super.initState();
    getWebsiteData();
  ...
  Future getWebsiteData() async {
    final url = Uri.parse('https://www.thesprucepets.com/dog-behavior-and-training-4162131');
    ...
    setState((){
      training_articles = List.generate(
        titles.length,
            (index) => Article(
          title: titles[index],
          url: urls[index],
        ...
        body: SingleChildScrollView(
          child: Column(children: <Widget>[
            ...
            ListView.builder(
              ...
              itemCount: training_articles.length,
              scrollDirection: Axis.vertical,
              shrinkWrap: true,
              itemBuilder: (context, index) {
                final article = training_articles[index];
