...
class FoodArticles extends StatefulWidget {
  const FoodArticles({Key? key}) : super(key: key);

  @override
  State<FoodArticles> createState() => _FoodArticlesState();
}

class _FoodArticlesState extends State<FoodArticles> {
  @override
  void initState(){
    super.initState();
    getWebsiteData();
  ...
  Future getWebsiteData() async {
    final url = Uri.parse('https://www.thesprucepets.com/dog-nutrition-and-food-4162139');
        ...
        body: SingleChildScrollView(
          child: Column(children: <Widget>[
            ...
            ListView.builder(
              ...
              itemCount: food_articles.length,
              scrollDirection: Axis.vertical,
              shrinkWrap: true,
              itemBuilder: (context, index) {
                final article = food_articles[index];
